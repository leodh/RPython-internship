...
class Appk(Contk):
    def __init__(self, name, funDict, k):
        self.name=name
        self.funDict=funDict
        self.k=k

    def apply(self, arg):
        g = GetFunc(self.funDict, self.name)
...
class Withk(Contk):
    def __init__(self, body, name, funDict, env, k):
        self.body = body
        self.name = name
        self.funDict = funDict
        self.env = env
    ...
    def apply(self, arg):
        ...
        return Interpk(self.body, self.funDict, self.env, self.k )
...
def Interpk(expr, funDict, env, k):
    ...
    #
        ...
        k2 = Withk(expr.body, expr.name, funDict, env, k)
